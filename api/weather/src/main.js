...
let getFiveDay = (zipcode) => {
  ...
  .then(json => {
    ...
    // For day 1
    let day1 = days[new Date(json.list[0].dt_txt).getDay()]; // I looked at this stack overflow solution on how to convert a date into a day of the week using getDay(): https://stackoverflow.com/questions/24998624/day-name-from-date-in-js
    let forecast1 = json.list[0].weather[0].main;
    let temp1 = json.list[0].main.temp;
    // For day 2
    let day2 = days[new Date(json.list[7].dt_txt).getDay()];
    let forecast2 = json.list[7].weather[0].main;
    let temp2 = json.list[7].main.temp;
    // For day 3
    let day3 = days[new Date(json.list[14].dt_txt).getDay()];
    let forecast3 = json.list[14].weather[0].main;
    let temp3 = json.list[14].main.temp;
    // For day 4
    let day4 = days[new Date(json.list[21].dt_txt).getDay()];
    let forecast4 = json.list[21].weather[0].main;
    let temp4 = json.list[21].main.temp;
    // For day 5
    let day5 = days[new Date(json.list[28].dt_txt).getDay()];
    let forecast5 = json.list[28].weather[0].main;
    let temp5 = json.list[28].main.temp;
    ...
    let $forecast = $('<div class="forecast"> <h2 class="label day-1">' + day1 + '</h2> <h2 class="label temp-1">' + convertToCelcius(temp1) + '°' + '</h2> <div class="small-icon icon-1"></div> <h2 class="label day-2">' + day2 + '</h2> <h2 class="label temp-2">' + convertToCelcius(temp2) + '°' + '</h2> <div class="small-icon icon-2"></div> <h2 class="label day-3">' + day3 + '</h2> <h2 class="label temp-3">' + convertToCelcius(temp3) + '°' + '</h2> <div class="small-icon icon-3"></div> <h2 class="label day-4">' + day4 + '</h2><h2 class="label temp-4">' + convertToCelcius(temp4) + '°' + '</h2> <div class="small-icon icon-4"></div> <h2 class="label day-5">' + day5 + '</h2> <h2 class="label temp-5">' + convertToCelcius(temp5) + '°' + '</h2> <div class="icon icon-5"></div> </div>');
